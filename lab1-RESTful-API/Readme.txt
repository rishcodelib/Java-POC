...
PUT-> http://localhost:8080/REST/api/user/5
{
   "name":"ramana",
   "age":48,
   "salary":70000
...
DELETE > http://localhost:8080/REST/api/user/2
